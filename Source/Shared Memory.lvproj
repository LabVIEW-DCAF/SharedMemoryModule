...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.1.128.142</Property>
...
# Generated by LabVIEW 13.0.1f12
# 2/7/2017 3:56:34 PM
...
DirectoryIndex index.htm
		...
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Shared Memory Class Reference.ctl" Type="VI" URL="/&lt;vilib&gt;/National Instruments/Shared Memory Library for Linux RT/Controls/Shared Memory Class Reference.ctl"/>
				<Item Name="Shared Memory.lvlib" Type="Library" URL="/&lt;vilib&gt;/National Instruments/Shared Memory Library for Linux RT/Shared Memory.lvlib"/>
			...
			<Item Name="read input file string.vi" Type="VI" URL="../editor node/read input file string.vi"/>
			<Item Name="read output file string.vi" Type="VI" URL="../editor node/read output file string.vi"/>
			...
			<Item Name="write C header file directory.vi" Type="VI" URL="../editor node/write C header file directory.vi"/>
			<Item Name="write c header file string.vi" Type="VI" URL="../editor node/write c header file string.vi"/>
			<Item Name="write input file string.vi" Type="VI" URL="../editor node/write input file string.vi"/>
			<Item Name="write output file string.vi" Type="VI" URL="../editor node/write output file string.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
